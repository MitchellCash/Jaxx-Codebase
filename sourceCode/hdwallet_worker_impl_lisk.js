...
var HDWalletWorkerLisk = function() {
    this._doDebug = true;
...
HDWalletWorkerLisk.networkParams = {
    static_relay_url: "",
    gather_tx: "",
    gather_tx_append: "",
    multi_balance: "",
...
HDWalletWorkerLisk.relayManagerParams = {
    isSupported: true,
    implementationFileName: "relay_manager_impl_lisk.js",
}

HDWalletWorkerLisk.prototype.initialize = function(workerManager) {
    this._workerManager = workerManager;
}

HDWalletWorkerLisk.prototype.log = function(logString) {
    if (this._doDebug === false) {
        return;
    }

    var args = [].slice.call(arguments);
    args.unshift('LiskWorkerLog:');
    console.log(args);
}
...
HDWalletWorkerLisk.prototype.batchScanBlockchain = function(addresses) {
    var self = this;
    var batch = [];
...
HDWalletWorkerLisk.prototype._populateHistory = function(addressData, passthroughParam) {
...
HDWalletWorkerLisk.prototype._lookupBitcoinTransactions = function(txids, callback) {
    var self = this;
...
HDWalletWorkerLisk.prototype._populateTransactionsBitcoin = function(transactions, callback) {
    if (!transactions) {
        if (callback) {
            callback({});
        }
...
HDWalletWorkerLisk.prototype._updateTransactionsBitcoin = function(transactions) {
...
HDWalletWorkerLisk.prototype.updateBalances = function() {
//    this.updateBalancesBitcoin();
}

HDWalletWorkerLisk.prototype.performRecheck = function() {
